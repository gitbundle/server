...
func MainTest(m *testing.M, testOpts *TestOptions) {
	...
	fixturesDir = filepath.Join(testOpts.GiteaRootPath, "pkg", "fixtures")
...
func CreateTestEngine(opts FixturesOptions) error {
	...
	switch os.Getenv("GITBUNDLE_UNIT_TESTS_LOG_SQL") {
	case "true", "1":
		x.ShowSQL(true)
	}
...
func PrepareTestEnv(t testing.TB) {
	...
	base.SetupGiteaRoot() // Makes sure GITBUNDLE_ROOT is set
}
