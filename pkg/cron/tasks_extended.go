...
import (
	...
	"github.com/gitbundle/server/pkg/admin"
...
func registerDeleteOldActions() {
	RegisterTaskFatal("delete_old_actions", &OlderThanConfig{
		...
		olderThanConfig := config.(*OlderThanConfig)
		return action_model.DeleteOldActions(olderThanConfig.OlderThan)
	})
}
...
func registerUpdateGiteaChecker() {
	...
	RegisterTaskFatal("update_checker", &UpdateCheckerConfig{
		...
		HTTPEndpoint: "https://dl.gitbundle.com/gitbundle-version.json",
	}, func(ctx context.Context, _ *user_model.User, config Config) error {
