...
import (
	...
	"github.com/gitbundle/server/pkg/notification/indexer"
	"github.com/gitbundle/server/pkg/notification/mail"
	"github.com/gitbundle/server/pkg/notification/ui"
	"github.com/gitbundle/server/pkg/notification/webhook"
...
func NotifyNewRelease(rel *release.Release) {
	for _, notifier := range notifiers {
...
func NotifyUpdateRelease(doer *user_model.User, rel *release.Release) {
	for _, notifier := range notifiers {
...
func NotifyDeleteRelease(doer *user_model.User, rel *release.Release) {
	for _, notifier := range notifiers {
