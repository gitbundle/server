...
func CreateTeam(ctx *context.APIContext) {
	...
	if err := repoman.NewTeam(team); err != nil {
...
func EditTeam(ctx *context.APIContext) {
	...
	if err := repoman.UpdateTeam(team, isAuthChanged, isIncludeAllChanged); err != nil {
...
func AddTeamMember(ctx *context.APIContext) {
	...
	if err := repoman.AddTeamMember(ctx.Org.Team, u.ID); err != nil {
...
func RemoveTeamMember(ctx *context.APIContext) {
	...
	if err := repoman.RemoveTeamMember(ctx.Org.Team, u.ID); err != nil {
...
func AddTeamRepository(ctx *context.APIContext) {
	...
	if err := repoman.AddRepository(ctx.Org.Team, repo); err != nil {
...
func RemoveTeamRepository(ctx *context.APIContext) {
	...
	if err := repoman.RemoveRepository(ctx.Org.Team, repo.ID); err != nil {
