...
func GetRelease(ctx *context.APIContext) {
	...
	release, err := release_model.GetReleaseByID(ctx, id)
...
func ListReleases(ctx *context.APIContext) {
	...
	filteredCount, err := release_model.CountReleasesByRepoID(ctx.Repo.Repository.ID, opts)
	if err != nil {
...
func CreateRelease(ctx *context.APIContext) {
	...
	if err != nil {
		...
		if err := release_service.CreateRelease(ctx.Repo.GitRepo, rel, nil, ""); err != nil {
			if release_model.IsErrReleaseAlreadyExist(err) {
