...
// ListDeployKeys list all the deployHandler keys of a repository
...
// GetDeployKey get a deployHandler key by id
...
func HandleAddKeyError(ctx *context.APIContext, err error) {
	...
	case asymkey_model.IsErrKeyAlreadyExist(err):
		ctx.Error(http.StatusUnprocessableEntity, "", "Key content has been used as non-deployHandler key")
...
// CreateDeployKey create deployHandler key for a repository
...
// DeleteDeploykey delete deployHandler key for a repository
