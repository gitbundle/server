...
import (
	...
	"github.com/gitbundle/server/pkg/updatechecker"
...
func Dashboard(ctx *context.Context) {
	...
	ctx.Data["Stats"] = metrics.GetStatistic()
...
func Config(ctx *context.Context) {
	...
	if len(os.Getenv("GITBUNDLE_WORK_DIR")) > 0 {
		envVars["GITBUNDLE_WORK_DIR"] = &envVar{"GITBUNDLE_WORK_DIR", os.Getenv("GITBUNDLE_WORK_DIR")}
	}
	if len(os.Getenv("GITBUNDLE_CUSTOM")) > 0 {
		envVars["GITBUNDLE_CUSTOM"] = &envVar{"GITBUNDLE_CUSTOM", os.Getenv("GITBUNDLE_CUSTOM")}
	}
