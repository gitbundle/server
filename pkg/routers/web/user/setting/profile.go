...
const (
	tplSettingsProfile      base.TplName = "user/settings/profile/public"
	tplSettingsAvatar       base.TplName = "user/settings/profile/avatar"
...
func Avatar(ctx *context.Context) {
	...
	ctx.HTML(http.StatusOK, tplSettingsAvatar)
}
