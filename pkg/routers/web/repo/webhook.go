...
func Webhooks(ctx *context.Context) {
	...
	ctx.Data["Description"] = ctx.Tr("repo.settings.hooks_desc", "https://docs.gitbundle.com/features/webhooks/")
...
// GitBundleHooksNewPost response for creating GitBundle webhook
func GitBundleHooksNewPost(ctx *context.Context) {
	giteaHooksNewPost(webhook.GITBUNDLE)
}

// GitBundleHooksNewPost response for creating GitBundle webhook
func GiteaHooksNewPost(ctx *context.Context) {
	giteaHooksNewPost(webhook.GITEA)
}

func giteaHooksNewPost(hookType string) func(ctx *context.Context) {
