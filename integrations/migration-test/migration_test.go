...
import (
	...
	"github.com/gitbundle/server/integrations"
...
func initMigrationTest(t *testing.T) func() {
	...
	if giteaRoot == "" {
		integrations.Printf("Environment variable $GITBUNDLE_ROOT not set\n")
		os.Exit(1)
	}
	...
	if giteaConf == "" {
		integrations.Printf("Environment variable $GITBUNDLE_CONF not set\n")
		os.Exit(1)
