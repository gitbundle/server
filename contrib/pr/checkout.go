...
import (
	...
	gitea_git "github.com/gitbundle/modules/git"
...
func runPR() {
	log.Printf("[PR] Starting gitbundle ...\n")
	curDir, err := os.Getwd()
	if err != nil {
		log.Fatal(err)
	}
	...
	*/
	...
	unittest.CopyDir(path.Join(curDir, "integrations/gitbundle-repositories-meta"), setting.RepoRootPath)
