...
const EnvironmentPrefix = "GITBUNDLE"
...
func main() {
	...
	Environment variables of the form "GITBUNDLE__SECTION_NAME__KEY_NAME"
	...
	You would set the environment variables: "GITBUNDLE__LOG_0x2E_CONSOLE__COLORIZE=false"
	and "GITBUNDLE__LOG_0x2E_CONSOLE__STDERR=false". Other examples can be found
